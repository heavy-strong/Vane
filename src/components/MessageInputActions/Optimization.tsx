      ...
      {({ open }) => (
        <>
          ...
          <PopoverPanel
            ...
            transition
            className="z-50 w-64 md:w-[250px] origin-bottom flex flex-col space-y-2 bg-light-primary dark:bg-dark-primary border rounded-lg border-light-200 dark:border-dark-200 p-2 max-h-[200px] md:max-h-none overflow-y-auto transition duration-100 ease-out data-[closed]:opacity-0 data-[closed]:scale-95"
          >
