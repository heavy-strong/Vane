  ...
  return (
    <Popover className="relative">
      ...
      <PopoverPanel
        ...
        transition
        className="z-50 w-64 md:w-[225px] origin-bottom flex flex-col bg-light-primary dark:bg-dark-primary border rounded-lg border-light-200 dark:border-dark-200 p-1 max-h-[200px] md:max-h-none overflow-y-auto shadow-lg transition duration-100 ease-out data-[closed]:opacity-0 data-[closed]:scale-95"
      >
